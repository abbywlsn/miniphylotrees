...
EMP_BUILD_CONFIG(PressureForDiversityConfig,
  ...
  VALUE(RANDOM_SEED, int, 1, "This is my random seed"),
);
...
// int numOrgs = 1000; 
 int parentNum;
 std::string file_name = "PD_norm_1000.csv"; 
...
int main(int argc, char * argv[]) {
    ...
    for(int gen = 100; gen <= config.GENERATION_COUNT(); gen = gen + 100){ 
